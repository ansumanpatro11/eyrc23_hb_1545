...
class HBController(Node):
    def __init__(self):
        ...
        self.pose_subs = self.create_subscription(Pose2D, '/detected_aruco_3', self.odometryCb, 10)
        
        self.kp = 21.6 # Proportional gain for position control
        self.ka = 24 # Proportional gain for angular control
