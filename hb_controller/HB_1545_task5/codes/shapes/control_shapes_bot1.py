...
class HBController(Node):
    def __init__(self):
        ...
        self.pid_const_linear={'Kp':0.2,'Ki':0.0,'Kd':0.001}
        self.pid_const_angular={'Kp':4.5,'Ki':0.001,'Kd':0.0006}
        ...
        self.bot_1_x,self.bot_1_y=triangle(self.bot_1_x,self.bot_1_y)
