...
class HBController(Node):
    def __init__(self):
        ...
        self.pen_bool = self.create_publisher(Bool, '/pen2_down', 10)

        
        self.pose_subs = self.create_subscription(Pose2D, '/pen2_pose', self.odometryCb, 10)
        ...
        self.pid_const_angular={'Kp':5,'Ki':0.05,'Kd':0.55}
        ...
        # self.msg_x=
        # self.msg_y=
        self.bot_2_x = [200,400,400,200,200]
        self.bot_2_y = [300,300,400,400,300]
        
        # self.bot_2_x,self.bot_2_y=rectangle(self.bot_2_x,self.bot_2_y)
