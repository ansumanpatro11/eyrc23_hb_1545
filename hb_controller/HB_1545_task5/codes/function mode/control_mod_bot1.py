...
class HBController(Node):
    def __init__(self):
        ...
        self.pid_const_linear={'Kp':0.9,'Ki':0.0,'Kd':0.0000001}
        self.pid_const_angular={'Kp':3.3,'Ki':0.0,'Kd':0.00009}
