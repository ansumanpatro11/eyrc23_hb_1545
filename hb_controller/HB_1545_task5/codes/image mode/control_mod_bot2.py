...
class HBController(Node):
    def __init__(self):
        ...
        self.pid_const_angular={'Kp':3.6,'Ki':0,'Kd':0.000012} #without using time at 0.2 theta
        ...
        self.bot_2_x,self.bot_2_y=get_cont_for_consecutive_contours(15,x_goals,y_goals,25)
...
def main(args=None):
    ...
    while rclpy.ok():
        if hb_controller.i < len(hb_controller.bot_2_x):
            ...
            y_goal=500-hb_controller.bot_2_y[hb_controller.i]
            theta_goal=0.0
            ...
            if (abs(e_x_rframe))> tolerance_dist or (abs(e_y_rframe))>tolerance_dist or (abs(hb_controller.getangle(e_theta)))>tolerance_theta:
                ...
                if hb_controller.i==len(hb_controller.bot_2_x):
                    ...
                    if hb_controller.ctr==1:
                        ...
                        hb_controller.bot_2_x, hb_controller.bot_2_y=get_cont_for_consecutive_contours(16,x_goals,y_goals,15)
                        ...
                        hb_controller.bot_2_x, hb_controller.bot_2_y=get_cont_for_consecutive_contours(8,x_goals,y_goals,6)
                        ...
                        # hb_controller.vel_pub.publish(hb_controller.vel)
                        # time.sleep(3)
                        hb_controller.bot_2_x, hb_controller.bot_2_y=get_cont_for_consecutive_contours(14,x_goals,y_goals,16)
                        
                        hb_controller.i=0
                        hb_controller.iter.data=hb_controller.i
                        hb_controller.iter_pub.publish(hb_controller.iter)
                    elif hb_controller.ctr==4:
                        hb_controller.bot_2_x, hb_controller.bot_2_y=get_cont_for_consecutive_contours(24,x_goals,y_goals,48)
                        
                        hb_controller.i=0
                        hb_controller.iter.data=hb_controller.i
                        hb_controller.iter_pub.publish(hb_controller.iter)
                    elif hb_controller.ctr==5:
                        hb_controller.bot_2_x, hb_controller.bot_2_y=get_cont_for_consecutive_contours(13,x_goals,y_goals,17)
                        ...
                        hb_controller.bot_2_x, hb_controller.bot_2_y=get_cont_for_consecutive_contours(7,x_goals,y_goals,5)
                        
                        hb_controller.i=0
                        hb_controller.iter.data=hb_controller.i
                        hb_controller.iter_pub.publish(hb_controller.iter)
                    elif hb_controller.ctr==7:
                        hb_controller.bot_2_x, hb_controller.bot_2_y=get_cont_for_consecutive_contours(9,x_goals,y_goals,6)
