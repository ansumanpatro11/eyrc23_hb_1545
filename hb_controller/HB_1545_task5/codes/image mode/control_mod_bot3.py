...
class HBController(Node):
    def __init__(self):
        ...
        self.bot_3_x,self.bot_3_y=get_cont_for_consecutive_contours(23,x_goals,y_goals,23)
        self.bot_3_x.reverse()
        self.bot_3_y.reverse()
...
def main(args=None):
    ...
    while rclpy.ok():
        if hb_controller.i < len(hb_controller.bot_3_x):
            ...
            y_goal=500-hb_controller.bot_3_y[hb_controller.i]
            theta_goal=0.0
            ...
            if (abs(e_x_rframe))< tolerance_dist and (abs(e_y_rframe))<tolerance_dist and (abs(hb_controller.getangle(e_theta)))<tolerance_theta and hb_controller.i==0 and hb_controller.ctr==0:
                
                hb_controller.pen_bool_msg.data=True
                hb_controller.pen_bool.publish(hb_controller.pen_bool_msg)
                time.sleep(2)
            elif (abs(e_x_rframe))< tolerance_dist and (abs(e_y_rframe))<tolerance_dist and (abs(hb_controller.getangle(e_theta)))<tolerance_theta and hb_controller.i==0 and hb_controller.ctr>0:
            ...
            if (abs(e_x_rframe))> tolerance_dist or (abs(e_y_rframe))>tolerance_dist or (abs(hb_controller.getangle(e_theta)))>tolerance_theta:
                ...
                print("zero")
                # time.sleep(1)
                if  hb_controller.i==0 and hb_controller.ctr>0:
                    hb_controller.i+=1
                if hb_controller.i==0 and hb_controller.ctr==0 and hb_controller.pen is True: 
                ...
                if hb_controller.i==len(hb_controller.bot_3_x):
                    ...
                    if hb_controller.ctr==1:
                        hb_controller.bot_3_x, hb_controller.bot_3_y=get_cont_for_consecutive_contours(12,x_goals,y_goals,13)
                        hb_controller.bot_3_x.reverse()
                        hb_controller.bot_3_y.reverse()
                        
                        hb_controller.i=0
                        hb_controller.iter.data=hb_controller.i
                        hb_controller.iter_pub.publish(hb_controller.iter)
                    elif hb_controller.ctr==2:
                        hb_controller.bot_3_x, hb_controller.bot_3_y=get_cont_for_consecutive_contours(6,x_goals,y_goals,25)
                        hb_controller.bot_3_x.reverse()
                        hb_controller.bot_3_y.reverse()
                        hb_controller.i=0
                        hb_controller.iter.data=hb_controller.i
                        ...
                        hb_controller.bot_3_x, hb_controller.bot_3_y=get_cont_for_consecutive_contours(3,x_goals,y_goals,8)
                        
                        hb_controller.i=0
                        hb_controller.iter.data=hb_controller.i
                        hb_controller.iter_pub.publish(hb_controller.iter)
                        
                    elif hb_controller.ctr==4:
                        hb_controller.bot_3_x, hb_controller.bot_3_y=get_cont_for_consecutive_contours(1,x_goals,y_goals,10)
                        hb_controller.bot_3_x.reverse()
                        hb_controller.bot_3_y.reverse()
                        hb_controller.i=0
                        hb_controller.iter.data=hb_controller.i
                    ...
                    elif hb_controller.ctr==5:
                        hb_controller.bot_3_x, hb_controller.bot_3_y=get_cont_for_consecutive_contours(10,x_goals,y_goals,6)
                        
                        hb_controller.i=0
                        hb_controller.iter.data=hb_controller.i
                        hb_controller.iter_pub.publish(hb_controller.iter)
                        
                    elif hb_controller.ctr==6:
                        hb_controller.bot_3_x, hb_controller.bot_3_y=get_cont_for_consecutive_contours(17,x_goals,y_goals,7)
                        
                        hb_controller.i=0
                        hb_controller.iter.data=hb_controller.i
                        hb_controller.iter_pub.publish(hb_controller.iter)
                    elif hb_controller.ctr==7:
                        hb_controller.bot_3_x, hb_controller.bot_3_y=get_cont_for_consecutive_contours(19,x_goals,y_goals,6)
                        hb_controller.i=0
                        hb_controller.iter.data=hb_controller.i
                        hb_controller.iter_pub.publish(hb_controller.iter)
                    elif hb_controller.ctr==8:
                        hb_controller.bot_3_x, hb_controller.bot_3_y=get_cont_for_consecutive_contours(21,x_goals,y_goals,23)
                        hb_controller.i=0
                        hb_controller.iter.data=hb_controller.i
                        hb_controller.iter_pub.publish(hb_controller.iter)
