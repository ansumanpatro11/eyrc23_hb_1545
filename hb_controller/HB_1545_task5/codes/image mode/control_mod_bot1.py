...
class HBController(Node):
    def __init__(self):
        ...
        self.stop_pub= self.create_publisher(Bool,'/stop_1',1)
        ...
        self.bot_1_x,self.bot_1_y=get_cont_for_consecutive_contours(20,x_goals,y_goals,19)
            ...
            if (abs(e_x_rframe))> tolerance_dist or (abs(e_y_rframe))>tolerance_dist or (abs(hb_controller.getangle(e_theta)))>tolerance_theta:
                ...
                if hb_controller.i==len(hb_controller.bot_1_x):
                    ...
                    if hb_controller.ctr==1:
                        hb_controller.bot_1_x, hb_controller.bot_1_y=get_cont_for_consecutive_contours(18,x_goals,y_goals,8)
                        
                        hb_controller.i=0
                        hb_controller.iter.data=hb_controller.i
                        hb_controller.iter_pub.publish(hb_controller.iter)
                    elif hb_controller.ctr==2:
                        hb_controller.bot_1_x, hb_controller.bot_1_y=get_cont_for_consecutive_contours(22,x_goals,y_goals,25)
                        ...
                        hb_controller.bot_1_x, hb_controller.bot_1_y=get_cont_for_consecutive_contours(11,x_goals,y_goals,13)
                        
                        hb_controller.i=0
                        hb_controller.iter.data=hb_controller.i
                        hb_controller.iter_pub.publish(hb_controller.iter)
                    elif hb_controller.ctr==4:
                        hb_controller.bot_1_x, hb_controller.bot_1_y=get_cont_for_consecutive_contours(5,x_goals,y_goals,26)
                        
                        hb_controller.i=0
                        hb_controller.iter.data=hb_controller.i
                        hb_controller.iter_pub.publish(hb_controller.iter)
                    elif hb_controller.ctr==5:
                        hb_controller.bot_1_x, hb_controller.bot_1_y=get_cont_for_consecutive_contours(2,x_goals,y_goals,7)
                        
                        hb_controller.i=0
                        hb_controller.iter.data=hb_controller.i
                        hb_controller.iter_pub.publish(hb_controller.iter)
                    elif hb_controller.ctr==6:
                        hb_controller.bot_1_x, hb_controller.bot_1_y=get_cont_for_consecutive_contours(4,x_goals,y_goals,16)
