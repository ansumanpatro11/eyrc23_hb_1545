...
img = cv2.imread("/home/ansuman/eyrc_HB/eyrc23_hb_1545/hb_controller/HB_1545_task5/codes/image/elephant.jpg")
    ...
    if state == cv2.EVENT_LBUTTONDOWN:
        with open("saved_contour.txt", "a") as file:
                    if contours_list is not None:
                        file.write(f"Detected Points for Contour {contour_num}:\n")
                        for point in contours_list:
                            file.write(f"{tuple(point[0])}\n")
        print("added to file")
